# Skript um gezielt spezifische deutsche Audiodateien zu transkribieren 
...
if not os.path.isfile(audio_path):
    ...
    try:
        ...
        result = model.transcribe(audio_path, language="de")  # Sprache optional angeben für bessere Genauigkeit
